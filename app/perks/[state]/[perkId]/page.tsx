...
function PerkFullBlock({ row }: { row: StatePerksOfferRow }) {
  ...
  return (
    <article className="rounded-lg border border-stone-200 bg-white px-4 py-4 text-sm shadow-sm">
  ...
  return (
    <ServiceSubpageFrame>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-xl flex-col gap-8 px-6 py-12 pb-20">
        ...
        {others.length > 0 ? (
          <section className="rounded-xl border border-stone-200 bg-stone-50/90 px-5 py-5">
